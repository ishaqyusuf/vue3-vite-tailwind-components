<template>
  <div
    ...
    :class="{
      'rounded-tl-full rounded-bl-full': day.date == 7,
    ...
    <slot>
      <button
        ...
        :class="{
          ...
          'text-gray-700': !day.isWeekend && !day.isSelected && !day.isDisabled,
          'text-gray-400': day.isWeekend && !day.isSelected && !day.isDisabled,
